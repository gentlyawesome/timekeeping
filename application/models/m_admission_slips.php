...
class M_admission_slips Extends CI_Model
{
	private $_table = 'admission_slips';
	...
	public function update_admission_slip($data = false, $where = false)
	{
		$this->db->set($data)->where('id',$where)->update($this->_table);
		return $this->db->affected_rows() > 0 ? array('status'=>'true') : array('status'=>'false');
	}
	
	public function delete_admission_slip($where = false)
	{
